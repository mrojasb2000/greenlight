...
// type for the message parameter, rather than just a a string type, as this gives us
// more flexibilitty over the values that we can include in the response.
...
func (app *application) methodNotAllowedResponse(w http.ResponseWriter, r *http.Request) {
	message := fmt.Sprintf("the %s method is not supported fr this resource", r.Method)
